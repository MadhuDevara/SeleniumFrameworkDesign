...
public class StandAloneTest {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("userEmail")).sendKeys("madhudevara.to@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("Devara@85");
		...
		//Verify all the products and verify by grabbing elements by finding 
		//Common elements
